...
// WE ONLY HAVE A LIMITIED NUMBER OF UI COMPONENT TYPES IN THIS APP
    ...
    public static final String SAGA_SCREEN_LEFT_BUTTON_TYPE = "SAGA_SCREEN_LEFT_BUTTON_TYPE";
    public static final String SAGA_SCREEN_RIGHT_BUTTON_TYPE = "SAGA_SCREEN_RIGHT_BUTTON_TYPE";
    public static final String SCORE_SCREEN_BUTTON_TYPE = "SCORE_SCREEN_BUTTON_TYPE";
    public static final String SCORE_TO_GAME_SCREEN_BUTTON_TYPE = "SCORE_TO_GAME_SCREEN_BUTTON_TYPE";
    public static final String GAME_TO_SCORE_SCREEN_BUTTON_TYPE = "GAME_TO_SCORE_SCREEN_BUTTON_TYPE";
    public static final String LEVEL_SELECT_1_BUTTON_TYPE = "LEVEL_SELECT_1_BUTTON_TYPE";
    public static final String LEVEL_SELECT_2_BUTTON_TYPE = "LEVEL_SELECT_2_BUTTON_TYPE";
    public static final String LEVEL_SELECT_3_BUTTON_TYPE = "LEVEL_SELECT_3_BUTTON_TYPE";
    public static final String LEVEL_SELECT_4_BUTTON_TYPE = "LEVEL_SELECT_4_BUTTON_TYPE";
    public static final String LEVEL_SELECT_5_BUTTON_TYPE = "LEVEL_SELECT_5_BUTTON_TYPE";
    public static final String LEVEL_SELECT_6_BUTTON_TYPE = "LEVEL_SELECT_5_BUTTON_TYPE";
    public static final String LEVEL_SELECT_7_BUTTON_TYPE = "LEVEL_SELECT_5_BUTTON_TYPE";
    public static final String LEVEL_SELECT_8_BUTTON_TYPE = "LEVEL_SELECT_5_BUTTON_TYPE";
    public static final String LEVEL_SELECT_9_BUTTON_TYPE = "LEVEL_SELECT_5_BUTTON_TYPE";
    public static final String LEVEL_SELECT_10_BUTTON_TYPE = "LEVEL_SELECT_5_BUTTON_TYPE";
    public static final String PLAY_AGAIN_BUTTON_TYPE = "PLAY_AGAIN_BUTTON_TYPE";
    public static final String SAGA_RETURN_BUTTON_TYPE = "SAGA_RETURN_BUTTON_TYPE";
    ...
    public static final String LEVEL_1_SCORE_SCREEN_STATE = "LEVEL_1_SCORE_SCREEN_STATE";
    public static final String LEVEL_2_SCORE_SCREEN_STATE = "LEVEL_2_SCORE_SCREEN_STATE";
    public static final String LEVEL_3_SCORE_SCREEN_STATE = "LEVEL_3_SCORE_SCREEN_STATE";
    public static final String LEVEL_4_SCORE_SCREEN_STATE = "LEVEL_4_SCORE_SCREEN_STATE";
    public static final String LEVEL_5_SCORE_SCREEN_STATE = "LEVEL_5_SCORE_SCREEN_STATE";
    public static final String LEVEL_6_SCORE_SCREEN_STATE = "LEVEL_6_SCORE_SCREEN_STATE";
    public static final String LEVEL_7_SCORE_SCREEN_STATE = "LEVEL_7_SCORE_SCREEN_STATE";
    public static final String LEVEL_8_SCORE_SCREEN_STATE = "LEVEL_8_SCORE_SCREEN_STATE";
    public static final String LEVEL_9_SCORE_SCREEN_STATE = "LEVEL_9_SCORE_SCREEN_STATE";
    public static final String LEVEL_10_SCORE_SCREEN_STATE = "LEVEL_10_SCORE_SCREEN_STATE";
    
    public static final String LEVEL_1_WIN_SCREEN_STATE = "LEVEL_1_WIN_SCREEN_STATE";
    public static final String LEVEL_1_LOSE_SCREEN_STATE = "LEVEL_1_LOSE_SCREEN_STATE";
    ...
    public static final String ROW_CLEAR_STATE = "ROW_CLEAR_STATE";
    public static final String COL_CLEAR_STATE = "COLUMN_CLEAR_STATE";
    public static final String WRAPPED_STATE = "WRAPPED_STATE";
    public static final String INCORRECTLY_SELECTED_STATE = "INCORECTLY_SELECTED_STATE";
    public static final String SPECIAL_SELECTED_STATE = "SPECIAL_SELECTED_STATE";
    ...
    public static final int TILE_STACK_X = 100;
    ...
    public static int NUM_TILES = 66;
    ...
    public static final Color ROW_CLEAR_TILE_COLOR = new Color(255,50,50,100);
    public static final Color COL_CLEAR_TILE_COLOR = new Color(225,50,50,100);
    public static final Color WRAPPED_TILE_COLOR = new Color(205,50,50,100);
    public static final Color SPECIAL_SELECTED_COLOR = new Color(131, 50, 196, 100);
    public static final Color CLOUD_COLOR = new Color(153, 255, 255, 100);
