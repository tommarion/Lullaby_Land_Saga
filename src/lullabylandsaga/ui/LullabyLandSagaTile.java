 ...
 */
public class LullabyLandSagaTile extends Sprite
{
    // EACH TILE IS EITHER AN A, B, C, D, OR E TYPE. IT MIGHT
     ...
     */
    public LullabyLandSagaTile(    SpriteType initSpriteType,
     ...
     * and returns true if they isNeighbor, false otherwise.
     * 
     * @param testTile The tile to compare this tile to.
     * 
     * @return true if this tile is a isNeighbor for the testTile argument,
     * false otherwise.
     */
    public boolean isNeighbor(LullabyLandSagaTile testTile)
    {
        // IF THE TILES ARE NEXT TO EACHOTHER
        if (this.getGridColumn() == testTile.getGridColumn())
            if(this.getGridRow() == testTile.getGridRow()-1
                    || this.getGridRow() == testTile.getGridRow()+1)
                return true;
        
        if (this.getGridRow() == testTile.getGridRow())
            if(this.getGridColumn() == testTile.getGridColumn()-1
                    || this.getGridColumn() == testTile.getGridColumn()+1)
                return true;
    ...
    @Override
    public LullabyLandSagaTile clone()
    {
        LullabyLandSagaTile clone = new LullabyLandSagaTile(this.spriteType, this.x, this.y, this.vX, this.vY, this.state, this.tileType);
        return clone;
    }
    ...
    public void update(MiniGame game)
    {
        ...
        else if (calculateDistanceToTarget() < 4)
        {
            vX = 0;
            vY = 0;
            x = targetX;
