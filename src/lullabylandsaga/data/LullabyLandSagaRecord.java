 ...
 */
public class LullabyLandSagaRecord
{
    // HERE ARE ALL THE RECORDS
    private HashMap<String, LullabyLandLevelRecord> levelRecords;

    /**
     * Default constructor, it simply creates the hash table for
     * storing all the records stored by level.
     */
    public LullabyLandSagaRecord()
    {
    ...
    {
        LullabyLandLevelRecord rec = levelRecords.get(levelName);
     ...
     * @param rec 
     */
    public void addLullabyLandLevelRecord(String levelName, LullabyLandLevelRecord rec)
    {
    ...
    public void addWin(String levelName, long winTime)
    {
        ...
        if (rec == null)
        {
            ...
            rec = new LullabyLandLevelRecord();
            rec.gamesPlayed = 1;
            rec.wins = 1;
            rec.losses = 0;
    ...
    public byte[] toByteArray() throws IOException
    {
        ...
        while(keysIt.hasNext())
        {
            ...
            dos.writeUTF(key);
            LullabyLandLevelRecord rec = levelRecords.get(key);
