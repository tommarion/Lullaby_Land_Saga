 ...
 */
public class LullabyLandSagaErrorHandler
{
     ...
     * @param initWindow 
     */
    public LullabyLandSagaErrorHandler(JFrame initWindow)
    {
     ...
     */
    public void processError(LullabyLandSagaPropertyType errorType)
    {
        ...
        String errorTitle = props.getProperty(LullabyLandSagaPropertyType.ERROR_DIALOG_TITLE_TEXT);
